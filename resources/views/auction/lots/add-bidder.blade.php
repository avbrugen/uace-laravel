                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-5">
                            <div class="form-group @if($errors->has('passport_issue'))has-error @endif">
                                ...
                                <input type="text" name="passport_issue" class="form-control input-lg" id="passport_issue" placeholder="" value="{{ old('passport_issue') }}">
                            </div>
                        </div>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group" style="margin-top: 40px; border: 1px solid rgb(228, 228, 228); padding-top: 6px;">
                            <div class="col-xs-8 checkbox">
                                <label>
                                    <input name="rules_agree" value="1" type="checkbox" @if(old('rules_agree')) checked @endif> Погоджуюсь із правилами проведення торгів/аукціонів  <span class="label-required">*</span>
                                </label>
                            </div>
                        ...
                        @if($errors->has('rules_agree'))<div class="alert alert-danger" style="margin-top: 15px">{{ $errors->first('rules_agree') }}</div>@endif
