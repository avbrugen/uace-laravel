    ...
    <div class="container">
        ...
        <div class="register_container">
            ...
            <form id="register_form-1" role="form" method="POST" action="/auth/register" @if($group == 1) style="display: block" @else style="display: none" @endif>
                ...
                <div class="row">
                    <div class="col-xs-6 checkbox">
                        <label>
                            <input type="checkbox" name="rules_agree" value="1"> Я погоджуюсь з правилами  <span class="label-required">*</span>
                        </label>
                    </div>
                    <div class="col-xs-6" style="margin-top: 10px;margin-bottom: 10px;">
                        <a href="/documents#c" target="blank" class="btn btn-warning btn-sm pull-right">Правила проведення торгів/аукціону</a>
                    </div>
                </div>
                @if($errors->has('rules_agree') && $group == 1)<div class="alert alert-danger" style="margin-top: 15px">{{ $errors->first('rules_agree') }}</div>@endif
            ...
            <form id="register_form-2" role="form" method="POST" action="/auth/register"  @if($group == 2) style="display: block" @else style="display: none" @endif>
                ...
                @if($errors->has('rules_agree') && $group == 2)<div class="alert alert-danger" style="margin-top: 15px">{{ $errors->first('rules_agree') }}</div>@endif
                <button type="submit" class="btn btn-primary btn-lg">Зареєструватися</button>
                <p class="pull-right"><span class="label-required">*</span> — обов'язкові поля.</p>
            </form>
