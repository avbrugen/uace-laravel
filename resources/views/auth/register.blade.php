...
<div class="container">
    ...
    <form id="register_form-1" role="form" method="POST" action="/auth/register" @if($group == 1) style="display: block" @else style="display: none" @endif>
        ...
        <div class="form-group @if($errors->has('LastName') && $group == 1)has-error @endif">
            <label for="InputLastName">Введіть прізвище</label>
            <input type="text" name="LastName" class="form-control input-lg" id="InputLastName" placeholder="Іванов">
        ...
        <div class="form-group @if($errors->has('FirstName') && $group == 1)has-error @endif">
            <label for="InputFirstName">Введіть ім'я</label>
            <input type="text" name="FirstName" class="form-control input-lg" id="InputFirstName" placeholder="Іван">
        ...
        <div class="form-group @if($errors->has('MiddleName') && $group == 1)has-error @endif">
            <label for="InputMiddleName">Введіть по-батькові</label>
            <input type="text" name="MiddleName" class="form-control input-lg" id="InputMiddleName" placeholder="Іванович">
        ...
        <div class="form-group @if($errors->has('phone') && $group == 1)has-error @endif">
            ...
            <input type="text" name="phone" class="form-control input-lg" id="InputPhone" placeholder="+38099-999-99-99">
        ...
        <div class="checkbox">
            <label>
                <input type="checkbox" name="rules_agree" value="1"> Я погоджуюсь з правилами
            </label>
        </div>
     ...
     <form id="register_form-2" role="form" method="POST" action="/auth/register"  @if($group == 2) style="display: block" @else style="display: none" @endif>
        ...
        <div class="form-group @if($errors->has('legal_entity') && $group == 2)has-error @endif">
            <label for="InputNameLegalEntity">Найменування юридичної особи</label>
            <input type="text" name="legal_entity" class="form-control input-lg" id="InputNameLegalEntity">
        ...
        <div class="form-group @if($errors->has('EDRPOUcode') && $group == 2)has-error @endif">
            <label for="InputEDRPOUcode">Введіть код ЄДРПОУ</label>
            <input type="text" name="EDRPOUcode" class="form-control input-lg" id="InputEDRPOUcode" placeholder="99999999">
        ...
        <div class="form-group @if($errors->has('LastName') && $group == 2)has-error @endif">
            <label for="InputLastName">Введіть прізвище представника</label>
            <input type="text" name="LastName" class="form-control input-lg" id="InputLastName" placeholder="Іванов">
        ...
        <div class="form-group @if($errors->has('FirstName') && $group == 2)has-error @endif">
            <label for="InputFirstName">Введіть ім'я представника</label>
            <input type="text" name="FirstName" class="form-control input-lg" id="InputFirstName" placeholder="Іван">
        ...
        <div class="form-group @if($errors->has('MiddleName') && $group == 2)has-error @endif">
            <label for="InputMiddleName">Введіть по-батькові представника</label>
            <input type="text" name="MiddleName" class="form-control input-lg" id="InputMiddleName" placeholder="Іванович">
