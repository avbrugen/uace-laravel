...
@section('content')
    ...
    <div class="container-fluid">
        <h2 class="sub-header">Учасники лоту №{{ $auction->id }}</h2>
        ...
        <table class="table">
            ...
            @foreach($auction->bidders as $bidder)
                ...
                <tr>
                    ...
                    <td><a class="open_bidder_info" href="#" data-toggle="modal" data-target="#myModal" data-bidder-id="{{ $bidder->id }}">Переглянути</a></td>
                </tr>
