...
<head>
    ...
    <link rel="stylesheet" href="{{url('//uace.com.ua/static/css/bootstrap.css')}}" />
        ...
        <div class="row">
            ...
            <div class="col-xs-3 col-md-3 col-lg-2 col_social">
                <div class="soc_buttons clearfix">
                    <a href="{{Config::get('app.twurl')}}" target="_blank" class="soc_button rss"></a>
                    <a href="{{Config::get('app.fburl')}}" target="_blank" class="soc_button fb"></a>
            ...
            <div class="col-lg-3 choice_lang">
                ...
                <form id="search" action="/auction/search" method="get">
                    <input type="text" name="q" placeholder="@lang('theme.search_placeholder')" class="search-input">
                </form>
            </div>
        </div>
    </div>
...
<div class="row">
    <aside id="aside-left" class="col-xs-3 col-md-3">
        <ul class="nav nav-pills nav-stacked sidebar-nav">
            <li><a href="/#c">@lang('theme.about')</a></li>
            <li><a href="/poslugi#c">@lang('theme.services')</a></li>
            <li><a href="/auctions">@lang('theme.auction')</a></li>
            <li><a href="/ogoloshenia#c">@lang('theme.ads')</a></li>
            <li><a href="/documents#c">@lang('theme.doc')</a></li>
            <li><a href="/news#c">@lang('theme.news')</a></li>
            <li><a href="/contacts#c">@lang('theme.cont')</a></li>
        </ul>
    </aside>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-3 col-md-3 col_last">
                <a href="/auctions" class="go_auction">@lang('theme.link_auction')</a><br><br>
