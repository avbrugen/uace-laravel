...
@section('title'){{ $currentCategory->name }} - Система електронних торгів - @lang('theme.sitename_title')@endsection
                        ...
                        <div class="form-horizontal clearfix sortBy">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <label class="col-xs-3">Відображати по:</label>
                                    <div class="col-xs-8">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <label class="col-xs-3 two">Сортувати:</label>
                                    <div class="col-xs-9">
                        ...
                        @if($auctions->count() > 0)
                            @foreach($auctions as $auction)
                                <div class="auction_item clearfix">
                                    <div class="col-xs-4"><img src="{{ $auction->img_min }}" alt="{{ $auction->title }}" class="img-responsive"></div>
                                    <div class="col-xs-8">
