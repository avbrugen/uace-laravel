    ...
    <div id="categories" class="row clearfix">
        ...
        @endforeach
            ...
            @elseif($currentCategory && $currentCategory->id == 30)
                <? $all_cat = 0; ?>
                <div class="current_category_filters col-md-12">
                    <form class="row search_small" action="{{ action('SearchController@getStuffQuery') }}">
                        <div class="col-xs-3">
                    ...
                    <form class="row search_full" action="{{ action('SearchController@getStuffQuery') }}" style="display: none">
                        <div class="col-xs-3">
            ...
            @elseif($currentCategory && $currentCategory->id == 39)
                <? $all_cat = 0; ?>
                <div class="current_category_filters col-md-12">
                    <form class="row search_small" action="{{ action('SearchController@getBuildQuery') }}">
                        <div class="col-xs-3">
                    ...
                    <form class="row search_full" action="{{ action('SearchController@getBuildQuery') }}" style="display: none">
                        <div class="col-xs-3">
            ...
            @elseif($currentCategory && $currentCategory->id == 6)
                <? $all_cat = 0; ?>
                <div class="current_category_filters col-md-12">
                    <form class="row search_small" action="{{ action('SearchController@getEquipmentQuery') }}">
                        <div class="col-md-3">
                    ...
                    <form class="row search_full" action="{{ action('SearchController@getEquipmentQuery') }}" style="display: none">
                        <div class="col-md-3">
            ...
            @elseif($currentCategory && $all_cat == 1)
                <div class="current_category_filters col-xs-12">
                    <form class="row search_small" action="/auction/search">
                        <div class="col-xs-3">
...
<style>
    ...
    .current_category_filters .col-xs-3, .current_category_filters .col-xs-2 {
        padding-left: 25px;
        padding-right: 25px;
    }
</style>